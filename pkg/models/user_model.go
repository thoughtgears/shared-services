...
type User struct {
	...
	CreatedAt  string  `json:"created_at" firestore:"created_at,firestore.ServerTimestamp"`
	UpdatedAt  string  `json:"updated_at" firestore:"updated_at,firestore.ServerTimestamp"`
}
